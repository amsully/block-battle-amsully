...
# Ideas:
# - Each block that can fit, 'fit it' into the board.
#     - Calculate all holes from bottom to max value.
#     - 
# - Calculating the move order
#     - enact all moves that are 'calculated' - if not in 'x, y' position search for variations of the order and take
#     the minimum distance to settling on the finish position
#     - 

class BestFitStrategy_2(AbstractStrategy):
