...
public class Shape {
        ...
        private Cell[] blocks; // array that contains only the block-cells of
                               // the shape
        private int size;
        ...
        /**
         * Set shape in square box. Creates new Cells that can be checked
         * against the actual playing field.
         */
